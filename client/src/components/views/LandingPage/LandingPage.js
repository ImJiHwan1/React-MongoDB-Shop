...
import { message, Button, Card, Icon, Col, Row, Collapse } from 'antd'
    ...
    const getProducts = (body) => {
        ...
        .then(response => {
            if(response.data.success) {
                ...
                message.success(" 상품들을 가져오는데 실패 했습니다. ")
            }
        })
      }
    ...
    return (
        <div style={{ width: '75%', margin: '3rem auto' }}>
            <div style={{ textAlign: 'center' }}>
                    <h2><Icon type="rocket" /> Let's Travel Anywhere <Icon type="rocket" /></h2>
            </div>
